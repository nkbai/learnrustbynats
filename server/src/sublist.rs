...
mod benchmark {
    ...
    #[bench]
    fn benchmark_match_single_token(b: &mut Bencher) {
    ...
    #[bench]
    fn benchmark_match_twotokens(b: &mut Bencher) {
        let mut s = get_test_sublist();
        b.iter(|| {
    ...
    #[bench]
    fn benchmark_match_fourtokens(b: &mut Bencher) {
        let mut s = get_test_sublist();
    ...
    #[bench]
    fn benchmark_match_fivetokens2(b: &mut Bencher) {
        let mut s = get_test_sublist();
        b.iter(|| {
    ...
    #[bench]
    fn benchmark_match_fivetokens3(b: &mut Bencher) {
        let mut s = get_test_sublist();
        b.iter(|| {
    ...
    #[bench]
    fn benchmark_match_fivetokens(b: &mut Bencher) {
        let mut s = get_test_sublist();
        b.iter(|| {
